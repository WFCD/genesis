...
import type { CommandLocaleModule } from './types';
...
export default {
  ...
  'settings.manage': {
    name: 'manage',
    description: 'Edit channel settings in a form',
  },
  'settings.manage.channel': {
    name: 'channel',
    description: 'Text channel to manage (defaults to current)',
  },
  'settings.diag': {
    name: 'diag',
