...
const fissures = [[], [], [], []];
const types = ['excavation', 'sabotage', 'mobiledefense', 'assassination',
  'extermination', 'hive', 'defense', 'interception', 'rathuum', 'conclave',
  'rescue', 'spy', 'survival', 'capture', 'darksector', 'hijack', 'assault',
  'evacuation'];

const queries = [SQL`select channel_id from type_notifications where type='fissures.t1';`,
...
Promise.each(queries, (query, index) => db.query(query)
  .then((results) => {
