...
const promoCodeEmbed = {
  ...
  fields: [{
    ...
    name: '_ _',
    value: '[SKILLUP](https://warframe.com/promocode?code=SKILLUP) • [ORIGINALWICKEDFUN](https://warframe.com/promocode?code=ORIGINALWICKEDFUN) • [MCGAMERCZ](https://warframe.com/promocode?code=MCGAMERCZ) • [HOMINVOCADO](https://warframe.com/promocode?code=HOMINVOCADO) • [MCIK](https://warframe.com/promocode?code=MCIK) • [TVSBOH](https://warframe.com/promocode?code=TVSBOH) • [BRICKY](https://warframe.com/promocode?code=BRICKY) • [NOOBLSHOWTEK](https://warframe.com/promocode?code=NOOBLSHOWTEK) • [SHUL](https://warframe.com/promocode?code=SHUL)',
  },
  ],
};
