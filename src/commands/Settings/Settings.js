...
class Settings extends Command {
  ...
  async composeChannelSettings(channel, message) {
    ...
    let tokens = [
      ...
      `**Temp Channel Category:** ${this.bot.client.channels.get(await this.settings.getGuildSetting(message.guild, 'tempCategory')) || 'none defined'}`,
      `**LFG Channel:** ${this.bot.client.channels.get(await this.settings.getGuildSetting(message.guild, 'lfgChannel')) || 'none defined'}`,
      `**Default Roles:** ${defaultRoles.length ? defaultRoles : 'none defined'}`,
      `**Vulgar Log Channel:** ${this.bot.client.channels.get(await this.settings.getGuildSetting(message.guild, 'vulgarLog')) || 'none defined'}`,
      ...
      `**Member Remove Log Channel:** ${this.bot.client.channels.get(await this.settings.getGuildSetting(message.guild, 'memberRemoveLog')) || 'none defined'}`,
      `**Ban Log Channel:** ${this.bot.client.channels.get(await this.settings.getGuildSetting(message.guild, 'banLog')) || 'none defined'}`,
      `**Unban Log Channel:** ${this.bot.client.channels.get(await this.settings.getGuildSetting(message.guild, 'unbanLog')) || 'none defined'}`,
