    ...
    if (ctx.createPrivateChannel) {
      ...
      if (userHasRoom) {
        ...
        try {
          ...
          this.logger.error(e);
          await this.messageManager.reply(message, 'unable to unlock the channel. Please either try again or review your invitations to ensure they are valid users.', true, true);
