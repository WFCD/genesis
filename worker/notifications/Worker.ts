...
import Rest from '#shared/utilities/RESTWrapper';
import Database from '#shared/settings/Database';
import { cachedEvents, locales } from '#shared/resources';
...
import TwitchNotifier from './twitch/TwitchNotifier';
...
class Worker {
  ...
  constructor() {
    ...
    return (async () => {
      deps.settings = await Database.build();
      return this;
    })();
  }
  async hydratePings() {
