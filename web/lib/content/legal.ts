...
export const privacyPolicy = {
  ...
  sections: [
    {
      title: 'Consent',
      paragraphs: ['By using Genesis, Warframe Hub, the Genesis dashboard, or other discord bots run by Matej Voboril ("the service"), you hereby consent to our Privacy Policy and agree to its terms.'],
    },
    {
